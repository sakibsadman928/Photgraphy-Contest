...
export default function ContestCard({ contest }: { contest: Contest }) {
  return (
    <Link
      ...
      className="group block overflow-hidden rounded-xl border border-hairline bg-surface shadow-sm transition-all hover:-translate-y-1 hover:border-accent/40"
    >
      ...
      <div className="p-5">
        <h3 className="font-display text-xl text-ink group-hover:text-accent-text">
          {contest.title}
        </h3>
